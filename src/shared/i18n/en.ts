...
export const en = {
  ...
  'backup.pickerTitle': 'Choose a folder for your backups',
  'backup.pickerWaiting': 'Opening your Drive…',
  'backup.folderChosen': 'Backups will go to {name}.',
  'backup.pickKept': 'Nothing changed — no folder was chosen.',
  'settings.backupOwnClient': 'Use my own Google client instead',
  'settings.backupNoClient': 'This build has no Google client compiled in, so the two fields below are the only way to connect.',
  'settings.backupFolder': 'Backup folder',
  'settings.backupFolderOwn': 'Matomeru — created by the app at the top of your Drive',
  'settings.backupChooseFolder': 'Choose folder',
  ...
  'settings.backupSetup': 'In Google Cloud, once: create a project, enable the Drive API, then create an OAuth client of type “Desktop app” and paste its two values below. Set the consent screen to “In production”, or Google expires the connection every seven days.',
  'settings.backupClientId': 'Client ID',
  'settings.backupClientSecret': 'Client secret',
  'settings.backupCredsSaved': 'Credentials saved.',
  ...
  'err.backupNoPickerKey': 'This build has no Google API key, so the folder picker cannot open.',
  'err.backupPickerTimeout': 'The folder picker was left open too long and was closed.',
  'err.backupPickerFailed': 'The folder picker could not be used: {reason}',
